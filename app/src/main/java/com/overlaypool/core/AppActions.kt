...
object AppActions {
    ...
    const val ACTION_TOGGLE_MANUAL_GUIDE = "com.overlaypool.action.TOGGLE_MANUAL_GUIDE"
    const val ACTION_CLOSE_MANUAL_GUIDE = "com.overlaypool.action.CLOSE_MANUAL_GUIDE"
